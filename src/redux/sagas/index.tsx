...
  yield all([(schemaSaga()), (pipelineSaga()), (DataBaseSaga()),(groupdataDataBaseSaga()),(recordSaga()),(projectSaga()),(projectByIdSaga()),(ComposePipelineSaga()),(groupSaga()),(ComposeReportsPipelineSaga())]);
