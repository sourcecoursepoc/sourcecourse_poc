...
import { CloudSyncOutlined, ClusterOutlined, FullscreenExitOutlined, GroupOutlined, UsergroupAddOutlined } from "@ant-design/icons";
      ...
      <div className={styles.outerbox}>
        <div className={styles.innerright}>
          <Row className={styles.image}>
            <Col>
              {title === "initialLoad" && (
                <ClusterOutlined style={{ fontSize: "2rem",alignContent:"center" }} />
              )}
              {title === "groups" && (
          ...
          <Row className={styles.imageName}>
            <Col style={{ marginLeft:"1rem",fontSize:"0.7rem",marginRight:"0.5rem"}}> {title}</Col>
          </Row>
        </div>
