...
const DisplaySchemaBox: React.FC<MyComponentProps> = ({ text, attribute, icon, uid, handleRemove, lengthOfColums, deleteIcon }) => {
    ...
    <>
      <div className={styles.outerbox}>
        ...
        <div style={{ width: 'inherit' }}>
          <Row className={styles.items}><Col style={{ width: '90%', fontSize: '0.875rem', textAlign: 'justify', height: 'auto', color: 'grey' }}>
            {text}</Col>
